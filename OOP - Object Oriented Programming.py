...
# InstancePointClass = Point()
# ## InstancePointClass.get_X = 3   get_X & get_Y methods are private, so you can use them from outside the class!
# ## InstancePointClass.get_Y = 2   get_X & get_Y methods are private, so you can use them from outside the class!
# InstancePointClass.set_X = 3      #we use set_X & set_Y methods instand to input data to get_X & get_Y
# InstancePointClass.set_Y = 2      #we use set_X & set_Y methods instand to input data to get_X & get_Y
# print(InstancePointClass)
